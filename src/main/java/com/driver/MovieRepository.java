...
public class MovieRepository {
    ...
    public void addMovDb(Movie movie){
        movieMap.put(movie.getName(), movie);
    }

    public void addDirDb(Director director){
        directorMap.put(director.getName(), director);
    }

    public void addMdPairDb(String movie, String director){
    ...
    public Movie getMovieDb(String movie){
        return movieMap.get(movie);
    }

    public Director getDirectorDb(String director){
